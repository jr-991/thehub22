...
// Loads a document from the chosen directory
        File file = new File("C:/Users/user/OneDrive - Queensland University of Technology/uni/cab302/pdfReader/pdf/test.pdf");
        ...
        System.out.print("Amount of sections: " + sections.length + "\n");
